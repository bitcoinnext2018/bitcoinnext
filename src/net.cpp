...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BitCoinNext " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"bitcoinnext.io", "n1.bitcoinnext.io"},
    {"bitcoinnext.io", "n2.bitcoinnext.io"},
    {"bitcoinnext.io", "n3.bitcoinnext.io"},
    {"bitcoinnext.io", "n4.bitcoinnext.io"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BitCoinNext is probably already running."), addrBind.ToString().c_str());
        else
